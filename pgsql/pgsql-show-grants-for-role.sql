-- Prints the direct privileges a role/user has been granted.
-- Get an overview of granted privileges of monitoring users.
--
-- Usage: psql -f pgsql-show-grants-for-role.sql -v rolename=YOUR_ROLE
-- Usage: cat pgsql-show-grants-for-role.sql | psql -f - -v rolename=YOUR_ROLE
-- Usage: cat pgsql-show-grants-for-role.sql | docker exec -i container psql -U superuser -d database -f - -v rolename=YOUR_ROLE
-- Source: https://stackoverflow.com/a/78466268
